...
class MWSProduct{
    ...
    public $standard_price_points;
    public $currency;
    public $restock_date;
    public $fulfillment_channel;
    ...
    public function toArray()
    {
        return [
            ...
            'standard-price-points' => $this->standard_price_points,
            'currency' => $this->currency,
            'restock-date' => $this->restock_date,
            'fulfillment-channel' => $this->fulfillment_channel,
            'handling-time' => $this->handling_time,
        ];
    }
